				...
				<div class="container">
					<div class="row">
						<div id="primary" class="col-xs-12 col-md-9">
							<h1><?php single_cat_title(); ?></h1> <!-- Fetching the title (category) of the page -->

							<!-- The loop -->
                            <?php while ( have_posts() ) {
                                the_post(); ?> <!-- Function for iterating through the postst -->
                            
							<article>
								<?php the_post_thumbnail(null, ['class' => 'img-responsive responsive--full', 'title' => 'Feature image'] ); ?> <!-- Fetching the post thumbnail -->
								<h2 class="title">
									<a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <!-- Fetching the permalink & the title for the post -->
								</h2>
								<ul class="meta">
									<li>
